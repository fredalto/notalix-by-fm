...
/* ===== DONNÉES (pile comme FA_niveau5.js) ===== */
var RANGE = [
...
// Repères d’intro
var REPERES = { "F3":1, "C4":1, "E2":1, "B2":1 };
...
function updateHUD(){
  ...
  // titre dynamique
  elLevelTitle.innerHTML = 'Défi Fa — Niveau <b>N'+level+'</b> (Objectif '+t+')';
  // stepper
  renderSteps(level);
  // chrono + barre + coeurs
...
function showQuestion(){
  ...
  noteImage.src = "Images/fa/" + currentCode + ".png";
}
