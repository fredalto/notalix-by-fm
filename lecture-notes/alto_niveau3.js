...
const STRINGS = [
  { // Do
    idx: 3, name: "Do",
    open:  { nom:"Do",  image:"note:ut3:C3", fingering:"0", s:3 },
    f1:    { nom:"Ré",  image:"note:ut3:D3", fingering:"1", s:3 },
    f2:    { nom:"Mi", image:"note:ut3:E3", fingering:"2", s:3 }
  },
  { // Sol
    idx: 0, name: "Sol",
    open:  { nom:"Sol", image:"note:ut3:G3", fingering:"0", s:0 },
    f1:    { nom:"La",  image:"note:ut3:A3", fingering:"1", s:0 },
    f2:    { nom:"Si",  image:"note:ut3:B3", fingering:"2", s:0 }
  },
  { // Ré
    idx: 1, name: "Ré",
    open:  { nom:"Ré",  image:"note:ut3:D4", fingering:"0", s:1 },
    f1:    { nom:"Mi",  image:"note:ut3:E4", fingering:"1", s:1 },
    f2:    { nom:"Fa",  image:"note:ut3:F4", fingering:"2", s:1 }
  },
  { // La
    idx: 2, name: "La",
    open:  { nom:"La",  image:"note:ut3:A4", fingering:"0", s:2 },
    f1:    { nom:"Si",  image:"note:ut3:B4", fingering:"1", s:2 },
    f2:    { nom:"Do",  image:"note:ut3:C5", fingering:"2", s:2 }
  },
];
