...
/* ===== DONNÉES (pile comme UT3_niveau5.js) ===== */
var RANGE = [
    "A2", "B2", 
...
// Repères d’intro
var REPERES = { "C4":1, "G4":1, "C3":1, "F3":1 };
...
function updateHUD(){
  ...
  // titre dynamique
  elLevelTitle.innerHTML = 'Défi Ut3 — Niveau <b>N'+level+'</b> (Objectif '+t+')';
  // stepper
  renderSteps(level);
  // chrono + barre + coeurs
...
function showQuestion(){
  ...
  noteImage.src = "Images/ut3/" + currentCode + ".png";
}
